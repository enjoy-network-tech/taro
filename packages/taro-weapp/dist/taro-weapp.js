(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TaroWeapp = {}));
  ...
  var dist = createCommonjsModule(function (module, exports) {
    ...
    var freeGlobal = (typeof commonjsGlobal === "undefined" ? "undefined" : _typeof$1(commonjsGlobal)) === 'object' && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal;
    ...
    function isSymbol(value) {
      return _typeof$1(value) === 'symbol' || isObjectLike(value) && objectToString.call(value) == symbolTag;
    }
    /**
    ...
    function isObject$1(val) {
      return val != null && _typeof$1(val) === 'object' && Array.isArray(val) === false;
    }
    ...
    function getEnv() {
      ...
      if (typeof commonjsGlobal !== 'undefined' && commonjsGlobal.__fbGenNativeModule) {
        _env = ENV_TYPE.RN;
        return ENV_TYPE.RN;
      }

      if (typeof commonjsGlobal !== 'undefined' && commonjsGlobal.getManifestField) {
    ...
    function commitAttachRef(ref, target, component, refs) {
      ...
      } else if (ref['fn'] && _typeof$1(ref['fn']) === 'object' && 'current' in ref['fn']) {
    ...
    function handleLoopRef(getElementById) {
      return function (component, id, type, handler) {
        ...
        var handlerType = _typeof$1(handler);
    ...
    function shallowEqual(obj1, obj2) {
      if (_typeof$1(obj1) !== 'object' && _typeof$1(obj2) !== 'object') {
        return obj1 === obj2;
      }
  ...
  unwrapExports(dist);
  var dist_1 = dist.Current;
  var dist_2 = dist.eventCenter;
  var dist_3 = dist.Component;
  var dist_4 = dist.Events;
  var dist_5 = dist.getEnv;
  var dist_6 = dist.ENV_TYPE;
  var dist_7 = dist.render;
  var dist_8 = dist.internal_safe_get;
  var dist_9 = dist.internal_safe_set;
  var dist_10 = dist.internal_inline_style;
  var dist_11 = dist.internal_get_original;
  var dist_12 = dist.internal_force_update;
  var dist_13 = dist.noPromiseApis;
  var dist_14 = dist.onAndSyncApis;
  var dist_15 = dist.otherApis;
  var dist_16 = dist.initPxTransform;
  var dist_17 = dist.createRef;
  var dist_18 = dist.commitAttachRef;
  var dist_19 = dist.detachAllRef;
  var dist_20 = dist.Link;
  var dist_21 = dist.interceptors;
  var dist_22 = dist.RefsArray;
  var dist_23 = dist.handleLoopRef;
  var dist_24 = dist.useEffect;
  var dist_25 = dist.useLayoutEffect;
  var dist_26 = dist.useReducer;
  var dist_27 = dist.useState;
  var dist_28 = dist.useDidShow;
  var dist_29 = dist.useDidHide;
  var dist_30 = dist.usePullDownRefresh;
  var dist_31 = dist.useReachBottom;
  var dist_32 = dist.usePageScroll;
  var dist_33 = dist.useResize;
  var dist_34 = dist.useShareAppMessage;
  var dist_35 = dist.useTabItemTap;
  var dist_36 = dist.useRouter;
  var dist_37 = dist.useScope;
  var dist_38 = dist.useRef;
  var dist_39 = dist.useCallback;
  var dist_40 = dist.useMemo;
  var dist_41 = dist.useImperativeHandle;
  var dist_42 = dist.invokeEffects;
  var dist_43 = dist.useContext;
  var dist_44 = dist.useShareTimeline;
  var dist_45 = dist.useAddToFavorites;
  var dist_46 = dist.createContext;
  var dist_47 = dist.memo;
  var dist_48 = dist.getIsUsingDiff;
  var dist_49 = dist.setIsUsingDiff;
  ...
  var SimpleMap = /*#__PURE__*/function () {
    function SimpleMap() {
      _classCallCheck$1(this, SimpleMap);

      this.cache = [];
      this.size = 0;
    }

    _createClass$1(SimpleMap, [{
      key: "set",
  ...
  */
  ...
  function genCompid(key, isNeedCreate) {
    if (!dist_1 || !dist_1.current || !dist_1.current.$scope) return [];
  ...
  function processEvent(eventHandlerName, obj) {
    ...
    obj[eventHandlerName] = function (event) {
      if (event) {
        ...
        Object.assign(event.currentTarget, event.detail); // 使用EventChannel派发点击事件，用来实现通用埋点

        if (event.type === 'tap') {
          dist_2.trigger('tracker-tap', event);
        }
      }
    ...
    if (key === 'componentDidMount') {
      if (component['$$refs'] && component['$$refs'].length > 0) {
        ...
        component['$$refs'].forEach(function (ref) {
          ...
          dist_18(ref, target, component, refs, true);
          ref.target = target;
        });
  ...
  function createComponent(ComponentClass, isPage) {
    ...
    try {
      dist_1.current = componentInstance;
      dist_1.index = 0;
  ...
  function doUpdate(component, prevProps, prevState) {
    ...
    if (component.$usedState && component.$usedState.length) {
      ...
      component.$usedState.forEach(function (key) {
        ...
        if (_typeof(val) === 'object') {
          if (isEmptyObject(val)) return dist_9(_data, key, {});
          val = cloneDeep(val);
          if (!isEmptyObject(val)) dist_9(_data, key, val);
        } else {
          dist_9(_data, key, val);
        }
      });
      data = _data;
    }
    ...
    var dataDiff = dist_48() ? diffObjToPath(data, component.$scope.data) : data;
      ...
      if (__mounted) {
        if (component['$$refs'] && component['$$refs'].length > 0) {
          component['$$refs'].forEach(function (ref) {
            ...
            if (target !== prevRef) {
              dist_18(ref, target, component, component.refs);
              ref.target = target;
            }
          });
        }
  ...
  var BaseComponent = /*#__PURE__*/function () {
    ...
    _createClass(BaseComponent, [{
      ...
      value: function setState(state, callback) {
        ...
        if (!this._disable) {
          enqueueRender(this, callback === dist_12);
        }
      }
    }, {
      key: "getState",
      ...
      value: function __triggerPropsFn(key, args) {
        ...
        if (reduxFnName in this) {
          ...
          if (keyChain.length > 0) {
            fn = dist_8(this[reduxFnName], keyChain.join('.'));
          } else {
            fn = this[reduxFnName];
          }
  ...
  var link = new dist_20(taroInterceptor);
  ...
  function processApis(taro) {
    var weApis = Object.assign({}, dist_14, dist_13, dist_15);
  ...
  function initNativeApi(taro) {
    ...
    taro.initPxTransform = dist_16.bind(taro);
  ...
  var Taro = {
    ...
    render: dist_7,
    ENV_TYPE: dist_6,
    internal_safe_get: dist_8,
    internal_safe_set: dist_9,
    internal_inline_style: dist_10,
    createComponent: createComponent,
    internal_get_original: dist_11,
    handleLoopRef: dist_23(getElementById),
    propsManager: propsManager,
    interceptors: dist_21,
    RefsArray: dist_22,
    genCompid: genCompid,
    useEffect: dist_24,
    useLayoutEffect: dist_25,
    useReducer: dist_26,
    useState: dist_27,
    useDidShow: dist_28,
    useDidHide: dist_29,
    usePullDownRefresh: dist_30,
    useReachBottom: dist_31,
    usePageScroll: dist_32,
    useResize: dist_33,
    useShareAppMessage: dist_34,
    useTabItemTap: dist_35,
    useShareTimeline: dist_44,
    useAddToFavorites: dist_45,
    useRouter: dist_36,
    useScope: dist_37,
    useRef: dist_38,
    useCallback: dist_39,
    useMemo: dist_40,
    useImperativeHandle: dist_41,
    useContext: dist_43,
    createContext: dist_46,
    memo: dist_47,
    shallowEqual: shallowEqual,
    setIsUsingDiff: dist_49
  };
  initNativeApi(Taro);
